 ...
 */
export const personaFramework: Record<PersonaType, PersonaAttributes> = {
  [PersonaType.HR_PEOPLE_OPS]: {
    type: PersonaType.HR_PEOPLE_OPS,
    motivations: [
  ...
  [PersonaType.TALENT_ACQUISITION]: {
    type: PersonaType.TALENT_ACQUISITION,
    motivations: [
